...
The main entities which the domain is comprised of are machine learning, big data, and the artificial aging of facial images.\\

A machine learning approach will be used to perform the process of artificial facial aging. To generate accurately aged faces, a conditional Generative Adversarial Neural Network must be trained on big data. The machine learning domain is greatly affected by this project, as it will be the first project publicly available that performs artificial facial aging. On a similar note, if this project can generate sufficient images, it will drastically improve upon current facial aging techniques. This would make it possible that this technique will become the industry standard for artificial facial aging.\\
